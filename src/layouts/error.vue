...
button {
  @apply rounded cursor-pointer bg-gray-200 py-2 px-4 text-gray-900 select-none transition-colors duration-100 dark:(bg-gray-700 text-gray-100 hover:bg-gray-800) hover:bg-gray-300 focus:outline-none;
}
</style>
