...
<template>
  ...
  <div v-if="error === false" class="w-full pt-14">
    <section class="space-y-4">
      <!-- Title -->
      <div class="bg-gray-200 h-10 w-full anime-pulse sm:w-8/12" />
      ...
      <div
        ...
        "
      >
        <div class="bg-gray-200 h-4 w-full anime-pulse sm:w-8/12" />
        <div class="bg-gray-200 h-4 w-1/2 anime-pulse sm:w-4/12" />
      </div>

      <!-- Reading time & date  -->
      <div class="flex space-x-2 justify-center sm:justify-start">
        <div class="bg-gray-200 h-4 animate-pulse w-1/4 sm:w-1/6" />
        <div class="bg-gray-200 h-4 animate-pulse w-1/4 sm:w-1/6" />
      </div>
    </section>
    ...
    <div class="space-y-10 mt-10 w-full">
      <div class="space-y-1">
        <div
          v-for="_ in 6"
          :key="_"
          class="bg-gray-200 h-4 animate-pulse"
